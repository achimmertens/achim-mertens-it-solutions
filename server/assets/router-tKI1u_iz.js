...
const appCss = "/assets/styles-1J0dZCUQ.css";
...
const logo = "/assets/logo-BAFgkzau.png";
const nav = [
  { to: "/", label: "Start" },
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 backdrop-blur-md bg-background/80 border-b border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-semibold tracking-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logo, alt: "Achim Mertens Logo", width: 36, height: 36, className: "h-9 w-9" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Achim Mertens" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline text-muted-foreground text-sm", children: "· IT Consulting" })
      ] }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "md:hidden border-t border-border bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 flex flex-col", children: nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: n.to,
...
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 bg-primary text-primary-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-14 grid md:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-3", children: "IT Consulting Mertens" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/70 leading-relaxed", children: "IT-Beratung, Programmierung & Webdesign aus Eschweiler. Pragmatisch, persönlich, herstellerunabhängig." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-3", children: "Kontakt" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "hover:text-accent", href: "mailto:achim_mertens@gmx.de?subject=Consultant%20Anfrage", children: "achim_mertens@gmx.de" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold mb-3", children: "Profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "https://www.linkedin.com/in/achim-mertens-97b0",
              target: "_blank",
              rel: "noreferrer",
              "aria-label": "LinkedIn",
              className: "p-2 rounded-md bg-white/10 hover:bg-accent transition-colors",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: "https://github.com/achimmertens",
              target: "_blank",
              rel: "noreferrer",
              "aria-label": "GitHub",
              className: "p-2 rounded-md bg-white/10 hover:bg-accent transition-colors",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              target: "_blank",
              rel: "noreferrer",
              "aria-label": "Hive Blockchain",
              className: "p-2 rounded-md bg-white/10 hover:bg-accent transition-colors font-bold text-sm",
              children: "H"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex gap-4 text-xs text-primary-foreground/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/impressum", className: "hover:text-accent", children: "Impressum" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/kontakt", className: "hover:text-accent", children: "Kontakt" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 py-4 text-center text-xs text-primary-foreground/50", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Achim Mertens · Gemäß § 19 UStG wird keine Umsatzsteuer berechnet."
    ] })
  ] });
}
...
const $$splitComponentImporter$6 = () => import("./ueber-mich-BTc4FlmI.js");
const Route$6 = createFileRoute("/ueber-mich")({
  head: () => ({
    meta: [{
      title: "Über mich · Achim Mertens"
    }, {
      name: "description",
      content: "Lebenslauf und Werdegang von Achim Mertens – freier IT-Consultant, Programmierer und Webdesigner aus Eschweiler."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./preise-Cw9YUvCw.js");
const Route$5 = createFileRoute("/preise")({
  head: () => ({
    meta: [{
      title: "Preise · Achim Mertens IT Consulting"
    }, {
      name: "description",
      content: "Transparente Stunden- und Pauschalpreise für IT-Beratung, Programmierung und Webdesign. Erste Stunde kostenlos."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./leistungen-_ydLJYKO.js");
const Route$4 = createFileRoute("/leistungen")({
  head: () => ({
    meta: [{
      title: "Leistungen · Achim Mertens IT Consulting"
    }, {
      name: "description",
      content: "IT-Beratung, IAM, Softwareentwicklung, Webdesign, Cloud & On-Premises, KI-Automatisierung und Schulungen."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./kontakt-BHmnZ3nM.js");
const Route$3 = createFileRoute("/kontakt")({
  head: () => ({
    meta: [{
      title: "Kontakt · Achim Mertens IT Consulting"
    }, {
      name: "description",
      content: "So erreichen Sie Achim Mertens – Telefon, E-Mail und Anschrift. Erste Beratungsstunde kostenlos."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./impressum-DXotIelz.js");
const Route$2 = createFileRoute("/impressum")({
  head: () => ({
    meta: [{
      title: "Impressum · Achim Mertens"
    }, {
      name: "description",
      content: "Impressum und Angaben gemäß § 5 TMG."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blog-CWOFzSmG.js");
const Route$1 = createFileRoute("/blog")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Aktuelle Artikel von Achim Mertens auf der Hive-Blockchain – zu IT, Doku, Anleitungen und mehr."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CZ-7lSRp.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Freier IT-Consultant für Beratung, Identity & Access Management, Softwareentwicklung, Webdesign, KI und Automatisierung."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const UeberMichRoute = Route$6.update({
  id: "/ueber-mich",
  path: "/ueber-mich",
  getParentRoute: () => Route$7
});
const PreiseRoute = Route$5.update({
  id: "/preise",
  path: "/preise",
  getParentRoute: () => Route$7
});
const LeistungenRoute = Route$4.update({
  id: "/leistungen",
  path: "/leistungen",
  getParentRoute: () => Route$7
});
const KontaktRoute = Route$3.update({
  id: "/kontakt",
  path: "/kontakt",
  getParentRoute: () => Route$7
});
const ImpressumRoute = Route$2.update({
  id: "/impressum",
  path: "/impressum",
  getParentRoute: () => Route$7
});
